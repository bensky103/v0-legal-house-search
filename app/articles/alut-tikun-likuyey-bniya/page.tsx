...
const COMMON_REPAIRS: { item: string; price: string }[] = [
  ...
  { item: "מסגרות פרגולה עם חלודה (ניקוי וצביעה)", price: "כ־248 ₪ למ״ר" },
  { item: "רפידות גומי מתחת לזכוכית מעקה", price: "כ־1,120 ₪ ליום עבודה" },
  { item: "הנמכת תקרה שאינה תקנית (תיקון פיזי)", price: "כ־4,500 ₪ ומעלה" },
  { item: "מוט בטיחות במסתור כביסה", price: "כ־742 ₪" },
]
