        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <Card className="mb-8 border-r-4 border-r-amber-500">
            <CardContent className="p-6 md:p-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                לדוגמה: אם <strong>איתור ליקויי בנייה</strong> העלה ממצאים בשווי תיקון של 50,000 ש&quot;ח, אתם יכולים לדרוש הנחה במחיר הדירה או לדרוש מהקבלן לתקן את הכל במעמד המסירה.
              </p>
          ...
          <Card className="mb-8 border-r-4 border-r-purple-500">
            <CardContent className="p-6 md:p-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-3 mb-4">
                <li><strong>במעמד מסירת הדירה, או סמוך לו ככל הניתן</strong> - הזמן המומלץ. רוב הקבלנים אינם מאפשרים בדק בית שבועות מראש, ולכן מתאמים את המומחה למועד המסירה עצמו: כך הליקויים נכנסים לפרוטוקול, והקבלן מתקן בעוד צוותיו והחומרים באתר ובלי שיוכל לטעון שהדייר גרם לליקוי</li>
          ...
          <ArticleDefectGallery
            ...
            intro="דוגמאות אמיתיות לליקויי בנייה שאותרו בבדק בית לדירות חדשות, רבים מהם במעמד המסירה מהקבלן. תיעוד מדויק של כל ליקוי הוא הבסיס לדרישת תיקונים ולמשא ומתן מול הקבלן."
