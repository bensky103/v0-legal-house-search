...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.legalbedek.co.il/articles/tikaney-instalatzia-bedek-bayit" },
  openGraph: {
...
export default function TikaneyInstalatziaArticle() {
  return (
    <ArticleLayout
      ...
      description="כך עובדים תקני האינסטלציה ת״י 1205 (מים, ביוב וניקוז) בבדק בית, ואיך מאתרים נזילות, סתימות ושיפועי ניקוז לקויים לפני שהם הופכים לנזק יקר."
