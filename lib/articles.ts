...
export const articles: ArticleMeta[] = [
  ...
  },
  {
    ...
    description:
      "טבלת הסטיות המותרות בטיח: אנכיות בטיח פנים 10 מ״מ בממוצע ועד 15 מ״מ בנקודה בודדת, בטיח חוץ 3 מ״מ; מישוריות 8 מ״מ בפנים ו-5 מ״מ בחוץ; גליות 4–5 מ״מ. קיר עקום אינו רק בעיה אסתטית, וטיח שהונח בעובי חורג סודק, מתפורר ופוגע באטימות הקיר.",
  ...
  },
  {
    ...
    description:
      "ת״י 1045 מחלק את הארץ לארבעה אזורי אקלים וגוזר מהם את דרישת הבידוד, ות״י 1523 בסעיף 7.2 מחייב לצמצם גשרי קור בחומרים מבודדים תרמית. מתי אסור גשר תרמי לחלוטין, מה נדרש בממ״ד ובתקרות הביניים, ולמה גשר קור שלא טופל נגמר בעובש גלוי או סמוי.",
