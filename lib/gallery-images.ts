...
export const galleryImages: GalleryImage[] = [
  ...
  // ---------- בדיקות אמיתיות (REAL INSPECTIONS) ----------
  {
    ...
    height: 1436,
    category: "inspection",
    title: "בדיקת ניצבות ואנכיות קיר בפלס",
    alt: "מומחה בדק בית בודק ניצבות ואנכיות של קיר בטון בעזרת פלס ארוך באתר בנייה לאיתור סטיות וליקויי בנייה בדירה חדשה",
    caption: "בדיקת ניצבות ואנכיות קיר בעזרת פלס ארוך - בדק בית לדירה חדשה באתר בנייה",
    keywords: [
      "בדק בית",
      "בדיקת ניצבות קיר",
      "אנכיות קיר",
  ...
  },
  {
    ...
    alt: "בדק בית - בדיקת חוזק ויציבות מעקה מתכת במרפסת בעזרת מד כו�� לאיתור ליקויי בטיחות ועמידה בתקן",
  ...
  },
  {
    ...
    alt: "בדק בית - בדיקת לוח חש��ל, מפסקים, ממסר פחת ומעגלי חשמל לאיתור ליקויי חשמל ובטיחות חשמלית בדירה",
