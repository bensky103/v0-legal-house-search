  ...
  return (
    ...
    >
      ...
      <ArticleFaq
        items={[
          {
            question: "מה נבדק בחשמל ובתקשורת בבדק בית?",
            answer:
              "נבדקים לוח החשמל (סימון, סידור ותקינות המפסקים והגנות הבטיחות), הנקודות, השקעים והמפסקים מול המפרט הטכני, וכן ארון התקשורת והתשתית שבתוכו. הבדיקה חזותית, ולעיתים מושלמת בבדיקה תרמית לאיתור התחממות יתר בחיבורים.",
          },
          {
            question: "מי מוסמך לתקן ליקויי חשמל בדירה?",
            answer:
              "כל טיפול, פירוק או תיקון בפועל של רכיב חשמלי — החלפת שקע, טיפול בחיבור רופף או שינוי בלוח — מחייב חשמלאי מוסמך בעל רישיון, בהתאם לחוק החשמל. תפקיד בדק הבית הוא לאתר ולתעד את הליקוי כדי להעביר אותו לטיפול מקצועי ובטוח, ולא לבצע תיקון עצמאי.",
          },
          {
            question: "כמה בתי תקע נדרשים בארון התקשורת הדירתי?",
            answer:
              "לפי תקנה 10.07(2) לתקנות התכנון והבנייה, בארון התקשורת שבכל דירה יותקנו 2 בתי תקע לחשמל לכל הפחות — כלומר חובת שקע כפול (או שני שקעים בודדים) בתוך הארון. בארון תקשורת מבני נדרשים 4 בתי תקע לכל הפחות. היעדרם הוא ליקוי הנבדק בבדק בית.",
          },
          {
            question: "האם חובה לסמן את לוח החשמל?",
            answer:
              "כן. תקנה 14 לתקנות החשמל קובעת כי מבטחים (כגון מא״זים), מפסקים וציוד מדידה ובקרה שבלוח חייבים להיות מסומנים בהתאם לייעודם. הסימון צריך להיות ברור, קריא, בשפה העברית ובר קיימא. סימון חסר מקשה לנתק את המעגל הנכון בשעת חירום, ולכן הוא נבדק בבדק בית.",
          },
        ]}
      />
    </ArticleLayout>
