  ...
  return (
    ...
    >
      ...
      <ArticleFaq
        items={[
          {
            question: "מה בודקים במרפסת בדירה חדשה ביום המסירה?",
            answer:
              "בודקים את איטום הרצפה (בעיקר בחיבור בין הרצפה לקיר ובהיקף פתחי הניקוז), את השיפועים אל נקודת הניקוז, את תפקוד הניקוז בפועל, את הריצוף ואת אף המים בסף הדלת. אלה האזורים שבהם מים חודרים ראשונים, ובדק בית מקצועי מודד ומתעד כל ליקוי בעודה באחריות הקבלן.",
          },
          {
            question: "איך בודקים שיפוע וניקוז במרפסת?",
            answer:
              "בבדק בית בודקים את כיוון השיפוע ואת מידתו, לרוב בעזרת פלס ובדיקת הצפה בפועל, ומוודאים שהמים מגיעים אל הניקוז ומתנקזים. שלולית שנשארת על הרצפה שעות אחרי הגשם היא סימן מובהק לליקוי. תקני הניקוז והאינסטלציה מפורטים בת״י 1205.",
          },
          {
            question: "למה כשלי איטום במרפסת מתגלים רק בחורף?",
            answer:
              "כשלי איטום ושיפוע אינם נראים בעין ביום שמש — הם מתגלים רק בגשם הראשון, כשהמים כבר חדרו וגרמו לרטיבות בקיר הפנימי, לכתמים ולעובש, ולעיתים לנזק אצל השכן שמתחת. בדיקת הצפה ומדידת שיפועים בבדק בית חושפות את הליקוי מראש, בעוד התיקון פשוט וזול.",
          },
          {
            question: "מי אחראי לאיטום ולשיפוע במרפסת בדירה חדשה?",
            answer:
              "איטום ושיפוע תקינים הם באחריות הקבלן במסגרת חוק המכר (דירות). ליקוי שמתועד בפרוטוקול המסירה הופך לדרישת תיקון מחייבת, ולכן תיעוד מסודר ביום המסירה מאפשר לדרוש מהקבלן תיקון יסודי על חשבונו.",
          },
        ]}
      />
    </ArticleLayout>
