      ...
      <main className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <ArticleFaq
            items={[
              {
                question: "כמה עולה בדק בית לדירה יד שנייה?",
                answer:
                  "עלות בדק בית לדירה יד שנייה נעה בדרך כלל בין כמה מאות לאלף ש\"ח, בהתאם לגודל הדירה ולהיקף הבדיקה. מול חיסכון פוטנציאלי של עשרות אלפי שקלים בליקויים סמויים ובמשא ומתן על המחיר, זו אחת ההשקעות המשתלמות ביותר בתהליך הרכישה.",
              },
              {
                question: "מתי הכי נכון לבצע בדק בית בדירה יד שנייה?",
                answer:
                  "העיתוי האידיאלי הוא לפני חתימה על חוזה הרכישה, כשעדיין יש לכם כוח מיקוח מלא ואפשרות לסגת מהעסקה. אם החוזה כולל תקופת בדיקות, נצלו אותה לבדיקה הנדסית מקצועית. בכל מקרה כדאי לבצע בדיקה נוספת לפני קבלת המפתחות.",
              },
              {
                question: "אילו ליקויים סמויים בדק בית חושף בדירה ישנה?",
                answer:
                  "בדיקה מקצועית חושפת רטיבות ונזילות סמויות, בעיות איטום, מערכות חשמל ישנות ולא תקניות, צנרת מחלידה וניקוז לקוי, סדקים ובעיות קונסטרוקציה, ליקויי ריצוף ומישוריות וכן בעיות בחלונות, בדלתות ובמרפסות — ליקויים שאינם נראים לעין הלא מקצועית.",
              },
              {
                question: "האם דוח בדק בית עוזר להוריד את מחיר הדירה?",
                answer:
                  "בהחלט. דוח בדק בית מפורט עם תיעוד מצולם והערכת עלויות תיקון הוא כלי המיקוח האפקטיבי ביותר מול המוכר. כשהליקויים מתועדים בצורה הנדסית, המוכר אינו יכול להתכחש להם, ולרוכשים רבים זה מאפשר הורדת מחיר משמעותית — לעיתים פי כמה מעלות הבדיקה.",
              },
              {
                question: "מי מוסמך לבצע בדק בית לדירה יד שנייה?",
                answer:
                  "בדק בית צריך להתבצע על ידי מומחה מוסמך עם ידע הנדסי וניסיון באיתור ליקויי בנייה. אנו מומחים מוסמכים מטעם איגוד המהנדסים וברישיון משרד העבודה, עם ציוד מדידה מקצועי הכולל מצלמה תרמית ומד לחות, ומספקים דוח מסודר וקביל בכל הארץ.",
              },
            ]}
          />
