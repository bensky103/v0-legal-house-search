...
export default function CityPage({ params }: { params: { city: string } }) {
  ...
  return (
    <SeoLandingTemplate
      ...
      intro={`${city.description} משרד בדק בית Legal מספק שירותי בדק בית הנדסי מקיפים ב${city.name} ובכל אזור ${city.region}. בין אם רכשתם דירה חדשה מקבלן או דירת יד שניה, אנו נבדוק את הנכס ביסודיות, נאתר ליקויי בנייה ונספק לכם חוות דעת מקצועית שתסייע לכם להבטיח את ההשקעה שלכם.`}
      features={[
        {
