  ...
  return (
    ...
    >
      ...
      <ArticleFaq
        items={[
          {
            question: "מה קובע ת״י 789 היום?",
            answer:
              "ת״י 789 מוכר כתקן הסטיות המותרות בעבודות בנייה, אך בפועל הוא צומצם מאוד. כיום הסטיות המותרות לכל רכיב מופיעות בתוך התקן הספציפי של אותו רכיב, ולא בתקן כללי אחד. המוקד המרכזי שנותר בת״י 789 הוא אנכיות ושיפוע של קירות.",
          },
          {
            question: "היכן נמצאות היום הסטיות המותרות לריצוף ולחיפוי?",
            answer:
              "רוב הטבלאות שהיו בת״י 789 הועברו אל התקנים הייעודיים. כדי לדעת מהי הסטייה המותרת לריצוף בודקים את תקן הריצוף (ת״י 1555 חלק 3), לחיפוי חוץ קרמי את ת״י 1555 חלק 1, לחלונות ותריסי אלומיניום את ת״י 1068 ות״י 1509, ולטיח את ת״י 1920 חלק 2.",
          },
          {
            question: "איך נמדדת סטיית אנכיות של קיר לפי התקן המעודכן?",
            answer:
              "בדיקת סטיית האנכיות של קיר לפי הגישה המעודכנת אינה מסתכמת בהצמדת פלס: היא דורשת בניית מודל ושבלונה ייעודית בגודל משמעותי לצורך המדידה. זהו תהליך מורכב שמבדיל בין בדיקה חובבנית לבדיקה הנדסית מקצועית.",
          },
          {
            question: "איך בדק בית מבחין בין ליקוי לסטייה מותרת?",
            answer:
              "בבדק בית מקצועי הסטיות נמדדות בכלים ייעודיים כמו פלס דיגיטלי ומאזנת לייזר למישוריות ולשיפוע, וסרגלים ופלסים ארוכים לריצוף. כל חריגה מתועדת מול התקן הרלוונטי, כך שניתן לקבוע באופן אובייקטיבי אם מדובר בליקוי שיש לתקן או בסטייה המותרת לפי התקן.",
          },
        ]}
      />
    </ArticleLayout>
