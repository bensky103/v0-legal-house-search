  ...
  return (
    ...
    >
      ...
      <ArticleFaq
        items={[
          {
            question: "מהי תקופת הבדק לפי חוק המכר (דירות)?",
            answer:
              "תקופת הבדק היא תקופה הקבועה בתוספת לחוק המכר (דירות), שמתחילה במועד מסירת הדירה, ולכל סוג ליקוי תקופה משלו. בתוכה הנטל על הקבלן — אם התגלה ליקוי הוא חייב לתקן, אלא אם יוכיח שהליקוי נגרם באשמת הרוכש. למשל, ריצוף וחיפוי פנים — שנתיים, כשל במערכות צנרת — 4 שנים, וכשל באיטום המבנה — 4 שנים.",
          },
          {
            question: "מה ההבדל בין תקופת בדק לתקופת אחריות?",
            answer:
              "בתקופת הבדק הנטל על הקבלן להוכיח שהליקוי נגרם באשמת הרוכש. תקופת האחריות היא שלוש שנים נוספות שמתחילות בתום תקופת הבדק, ובתוכה הרוכש הוא שצריך להוכיח שמקור הליקוי בתכנון, בעבודה או בחומרים.",
          },
          {
            question: "כמה זמן אחראי הקבלן על אי-התאמה יסודית?",
            answer:
              "אי-התאמה יסודית היא ליקוי בחלקי המבנה הנושאים עומסים והנוגע ליציבות המבנה ולבטיחותו. עליה הקבלן אחראי עד 20 שנה ממועד המסירה.",
          },
          {
            question: "עד מתי צריך להודיע לקבלן על ליקוי?",
            answer:
              "ליקוי שניתן היה לגלותו בעת המסירה — יש להודיע עליו לקבלן בתוך שנה ממועד המסירה. ליקוי נסתר — יש להודיע עליו תוך זמן סביר מרגע שהתגלה. כאן נכנס בדק בית: בדיקה הנדסית במועד המסירה מתעדת את כל הליקויים הגלויים בזמן, כך שלא תאבדו את הזכות לדרוש את תיקונם.",
          },
        ]}
      />
    </ArticleLayout>
