        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "Person",
                "@id": "https://www.legalbedek.co.il/#yigal-bensky",
                name: "יגאל בנסקי",
                ...
                worksFor: { "@id": "https://www.legalbedek.co.il/#organization" },
              },
              {
                ...
                logo: "https://www.legalbedek.co.il/logo.webp",
                image: "https://www.legalbedek.co.il/gallery/yigal-bensky-mumche-bedek-bayit.webp",
                telephone: "+972-50-627-7858",
                email: "yigalbensky@gmail.com",
                priceRange: "$$",
                ...
                founder: { "@id": "https://www.legalbedek.co.il/#yigal-bensky" },
                employee: { "@id": "https://www.legalbedek.co.il/#yigal-bensky" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
            ...
            <Card className="hover:shadow-lg transition-shadow overflow-hidden border-r-4 border-r-green-500">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-3 font-medium">
                  {"\"אני קורא ולומד את הדוח שלך. יש לא מעט ליקויים שלא הבחנתי בהם אף על פי שחיפשתי. מעולה.\""}
                </p>
                <figure className="rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                  <Image
                    ...
                    title="ביקורת לקוח מאילת על בדק בית לדירה יד שנייה"
                    width={1220}
                    height={410}
                    loading="lazy"
                    className="w-full h-auto object-cover"
                  />
                  <figcaption className="sr-only">ביקורת לקוח בוואטסאפ - בדק בית לדירה יד שנייה באילת, הדוח איתר ליקויים שלא נראו לעין הרוכש</figcaption>
                </figure>
                <p className="font-semibold text-gray-900 mt-3">דוד, אילת</p>
              </CardContent>
            </Card>
            <Card className="hover:shadow-lg transition-shadow overflow-hidden border-r-4 border-r-green-500">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-3 font-medium">
                  {"\"הי יגאל, אני רוצה להודות לך על הבדק בית שעשית לנו בדירה. עשית בדיקה מאוד יסודית ומעמיקה עם הסברים והוראות פעולה מדויקים. תודה על המענה המהיר והזמינות הגבוהה!\""}
                </p>
                <figure className="rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                  <Image
                    src="/images/bikoret-bedek-bayit-avigail.webp"
                    alt="ביקורת בדק בית בוואטסאפ מאביגל מרעננה - בדיקה יסודית ומעמיקה עם הסברים והוראות פעולה מדויקים, שירות מקצועי וזמין"
                    title="ביקורת לקוחה מרעננה על בדק בית לדירה"
                    width={1213}
                    height={663}
                    loading="lazy"
                    className="w-full h-auto object-cover"
                  />
                  <figcaption className="sr-only">
                    ביקורת לקוחה בוואטסאפ - בדק בית יסודי ומעמיק בדירה ברעננה, שירות מקצועי וזמין
                  </figcaption>
                </figure>
            ...
            <Card className="hover:shadow-lg transition-shadow overflow-hidden border-r-4 border-r-green-500">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-3 font-medium">
                  {"\"אני אעבור על הדוח, נראה מקצועי ביותר. תמחור יפה מאוד. פצצה, שמע אתה אלוף!\""}
                </p>
                <figure className="rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                  <Image
