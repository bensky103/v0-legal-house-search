...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    region: "אזור הדרום",
    description:
      "קריית גת, ובראשה שכונת כרמי גת, היא מהאזורים הצומחים ביותר בדרום עם אלפי דירות חדשות מקבלן בבנייה מהירה — עובדה שמחייבת בדק בית הנדסי מוקפד במעמד המסירה.",
  },
  {
    slug: "lod",
    name: "לוד",
    ...
    region: "אזור המרכז",
    description:
      "לוד מתחדשת במהירות עם רבעים חדשים כמו הרובע הבינלאומי ונופי בן שמן, המציעים דירות חדשות מקבלן לצד התחדשות עירונית — ודורשים בדיקה הנדסית מקצועית לפני קבלת הדירה.",
  },
  {
    slug: "beer-yaakov",
    name: "באר יעקב",
    ...
    region: "אזור המרכז",
    description:
      "באר יעקב היא מהיישובים הצומחים במרכז הארץ, עם שכונות מגורים חדשות ובנייה רוויה מואצת שבהן בדק בית במועד המסירה חיוני להבטחת איכות הבנייה.",
  },
  {
    slug: "gedera",
    name: "גדרה",
    ...
    region: "אזור המרכז",
    description:
      "גדרה מתרחבת עם שכונות מגורים חדשות בדרום השפלה, המשלבות בנייה רוויה וצמודת קרקע — ודורשות בדיקה הנדסית מקצועית בדירות חדשות מקבלן.",
  },
  {
    slug: "bet-shemesh",
    name: "בית שמש",
    ...
    region: "אזור ירושלים",
    description:
      "בית שמש היא מהערים הצומחות במבואות ירושלים, עם שכונות חדשות רבות ובנייה מואצת על קרקע הררית — מה שמחייב בדק בית הנדסי מוקפד בדירות חדשות מקבלן.",
  },
  {
    slug: "kiryat-malachi",
    name: "קריית מלאכי",
    nameSimple: "קריית מלאכי",
    region: "אזור הדרום",
    description:
      "קריית מלאכי מתרחבת עם שכונות חדשות כמו כרמי הנדיב, המציעות דירות חדשות מקבלן הדורשות בדיקה הנדסית מקצועית במעמד המסירה.",
  },
  {
    slug: "ramla",
    name: "רמלה",
    ...
    region: "אזור המרכז",
    description:
      "רמלה עוברת התחדשות עירונית ובנייה חדשה, עם רבעים כמו שער העיר המציעים דירות חדשות שדורשות בדק בית הנדסי לפני קבלת המפתח.",
  },
  {
    slug: "or-akiva",
    name: "אור עקיבא",
    nameSimple: "אור עקיבא",
    region: "אזור השרון",
    description:
      "אור עקיבא צומחת עם שכונות מגורים חדשות סמוך למישור החוף, ובנייה רוויה חדשה הדורשת בדיקה הנדסית מקצועית — עם דגש על איטום מול קרבה לים.",
  },
  {
    slug: "ganei-tikva",
    name: "גני תקווה",
    nameSimple: "גני תקווה",
    region: "גוש דן",
    description:
      "גני תקווה, במרכז גוש דן, מציעה בנייה חדשה ואיכותית בשכונות מבוקשות — ובדק בית במועד המסירה מבטיח שהדירה תואמת את המפרט והתקנים.",
  },
  {
    slug: "tzfat",
    name: "צפת",
    ...
    region: "אזור הצפון",
    description:
      "צפת, מהערים העתיקות בגליל העליון היושבת על רכס הררי בגובה כ-900 מטר, מתחדשת עם שכונות ופרויקטי מגורים חדשים כמו שכונת איביקור. הבנייה ההררית והאקלים הקר מחייבים בדק בית הנדסי מוקפד, עם דגש על יסודות, איטום ובידוד תרמי.",
  },
]
...
export const contractors: ContractorData[] = [
  ...
  {
    slug: "tidhar",
    projects: ["מרחב פארק המסילה, תל אביב", "התחדשות עירונית ציר כצנלסון, גבעתיים", "התחדשות בת גלים, חיפה", "ציר קוממיות, בת ים", "מרינה הרצליה, הרצליה"],
    name: "תדהר",
    nameWithShel: "תדהר",
    description:
  ...
  {
    slug: "electra",
    projects: ["שכונת הים אכזיב, נהריה"],
    name: "אלקטרה נדל\"ן",
    nameWithShel: "אלקטרה נדל\"ן",
    description:
      "אלקטרה נדל\"ן, מקבוצת אלקו, היא מחברות הנדל\"ן הגדולות בישראל, עם פרויקטי מגורים ומסחר רבים. אלקטרה מגורים, הזרוע היזמית למגורים, מקימה בין היתר את שכונת הים אכזיב על חוף אכזיב.",
  },
  {
    slug: "danya-cebus",
    name: "דניה סיבוס",
  ...
  },
  {
    ...
    description:
      "חברת צמח המרמן היא מחברות הבנייה הוותיקות בישראל, עם פרויקטי מגורים רבים בצפון ובמרכז הארץ, ובהם שכונת הים אכזיב על חוף אכזיב, בשיתוף אלקטרה מגורים.",
  },
  {
    slug: "hanan-mor",
