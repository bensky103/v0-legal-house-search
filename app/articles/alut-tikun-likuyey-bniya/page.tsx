  ...
  return (
    ...
    >
      ...
      <ArticleFaq
        items={[
          {
            question: "כמה עולה לתקן ליקויי בנייה בדירה?",
            answer:
              "עלות תיקון הליקויים בדירה בודדת מגיעה לרוב לעשרות אלפי שקלים. בדוגמה אמיתית של דירת 3.5 חדרים עם 72 ממצאים, עלות התיקונים הסתכמה בכ־113,000 ₪ לפני תוספות, ולאחר פיקוח הנדסי, בלתי־צפוי ומע״מ הגיעה לכ־160,000 ₪. הסכום המדויק משתנה לפי מספר הליקויים ואופיים.",
          },
          {
            question: "איך מחושבת עלות תיקון ליקוי בדוח בדק בית?",
            answer:
              "ההערכה מתבססת על מחירונים מקובלים בענף הבנייה, לפי יחידת מדידה מתאימה לכל עבודה — למטר, למטר רבוע, ליום עבודה או ליחידה. לכל ליקוי נקבעים כמות ומחיר ליחידה, ומכפלתם היא עלות התיקון של הסעיף. בסיכום הדוח מתווספים לרוב פיקוח הנדסי, בלתי־צפוי ומע״מ.",
          },
          {
            question: "למה עלות התיקון בשוק הפרטי גבוהה מהמחיר בדוח?",
            answer:
              "המחירים בדוח הם מחירי עלות לקבלן. בשוק הפרטי, כשמזמינים בעל מקצוע לתיקון נקודתי בדירה מאוכלסת, העלות בפועל גבוהה משמעותית — משום שעבודה נקודתית יקרה יותר מאותה עבודה כחלק מפרויקט רציף באתר. לכן מדובר בהערכה ולא במחיר סופי מחייב.",
          },
          {
            question: "האם כדאי לבצע בדק בית ביחס לעלות התיקונים?",
            answer:
              "כן. עלות הבדיקה זניחה ביחס לעלות תיקון הליקויים, שמגיעה בקלות לעשרות אלפי שקלים, ובוודאי ביחס להנחה שאפשר להשיג במשא ומתן. הסכום הכולל בדוח הופך לכלי מיקוח — אפשר לדרוש מהקבלן לתקן על חשבונו לפי חוק המכר, או לדרוש הפחתה מהמחיר בעסקת יד שנייה.",
          },
        ]}
      />
    </ArticleLayout>
