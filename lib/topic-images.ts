...
const DEFECT_IMAGES: Record<string, string[]> = {
  ...
  ovesh: [
    GF("mad-nekudat-tal-gesher-termi-tziyud-bedek-bayit.webp"),
    G("bedek-bayit-mad-lachut-tikra-hitkalfut-tiyach-chashad-ovesh"),
  ...
  itum: [
    ...
    GF("bedek-bayit-likui-itum-18.webp"),
    GF("bedek-bayit-likui-itum-19.webp"),
    GF("bedek-bayit-likui-itum-20.webp"),
    GF("bedek-bayit-likui-itum-13.jpg"),
    GF("bedek-bayit-likui-itum-14.jpg"),
    GF("bedek-bayit-likui-itum-15.jpg"),
    GF("bedek-bayit-likui-itum-16.jpg"),
  ...
  ritzuf: [
    ...
    GF("bedek-bayit-likui-ritzuf-28.webp"),
    GF("bedek-bayit-likui-ritzuf-29.webp"),
    GF("bedek-bayit-likui-ritzuf-30.webp"),
    GF("bedek-bayit-likui-ritzuf-31.webp"),
    GF("bedek-bayit-likui-ritzuf-32.webp"),
    GF("bedek-bayit-likui-ritzuf-33.webp"),
    GF("bedek-bayit-likui-ritzuf-34.webp"),
    GF("bedek-bayit-likui-ritzuf-35.webp"),
  ...
  instalatzia: [
    ...
    GF("bedek-bayit-likui-instalatzia-25.webp"),
    GF("bedek-bayit-likui-instalatzia-26.webp"),
    GF("bedek-bayit-likui-instalatzia-27.webp"),
    GF("bedek-bayit-likui-instalatzia-28.webp"),
    GF("bedek-bayit-likui-instalatzia-29.webp"),
    GF("bedek-bayit-likui-instalatzia-30.webp"),
    GF("bedek-bayit-likui-instalatzia-31.webp"),
    GF("bedek-bayit-likui-instalatzia-32.webp"),
    GF("bedek-bayit-likui-instalatzia-33.webp"),
    GF("bedek-bayit-likui-instalatzia-34.webp"),
    GF("bedek-bayit-likui-instalatzia-35.webp"),
    GF("bedek-bayit-likui-instalatzia-36.webp"),
    GF("bedek-bayit-likui-instalatzia-37.webp"),
  ...
  chashmal: [
    G("bedek-bayit-matzlema-termit-luach-chashmal"),
    GF("bedek-bayit-likui-chashmal-16.webp"),
    GF("bedek-bayit-likui-chashmal-17.webp"),
    GF("bedek-bayit-likui-chashmal-18.webp"),
    GF("bedek-bayit-likui-chashmal-19.webp"),
    GF("bedek-bayit-likui-chashmal-20.webp"),
    GF("bedek-bayit-likui-chashmal-15.jpg"),
  ...
  chalonot: [
    G("bedek-bayit-mad-oviy-zchuchit-chalon"),
    GF("bedek-bayit-bdikat-zchuchit-01.webp"),
  ...
  mamad: [
    GF("bedek-bayit-likui-mamad-05.webp"),
    GF("bedek-bayit-likui-mamad-06.webp"),
    GF("bedek-bayit-likui-mamad-07.webp"),
    GF("bedek-bayit-likui-mamad-08.webp"),
    GF("bedek-bayit-likui-mamad-09.webp"),
    GF("bedek-bayit-likui-mamad-10.webp"),
    GF("bedek-bayit-likui-mamad-11.webp"),
  ...
  madregot: [
    G("bedek-bayit-medidat-omek-shelach-madrega"),
  ...
  chipuyim: [
    ...
    GF("bedek-bayit-likui-chipuyim-20.jpg"),
  ...
  tiyach: [
    ...
    GF("bedek-bayit-likui-tiyach-15.webp"),
    GF("bedek-bayit-likui-tiyach-16.webp"),
    GF("bedek-bayit-likui-tiyach-09.jpg"),
    GF("bedek-bayit-likui-tiyach-10.jpg"),
    GF("bedek-bayit-likui-tiyach-11.jpg"),
  ...
  mitbach: [
    GF("bedek-bayit-mitbach-12.webp"),
    GF("bedek-bayit-mitbach-13.webp"),
    GF("bedek-bayit-mitbach-01.jpg"),
    GF("bedek-bayit-mitbach-02.jpg"),
    GF("bedek-bayit-mitbach-03.jpg"),
    GF("bedek-bayit-mitbach-04.jpg"),
    GF("bedek-bayit-mitbach-05.jpg"),
    GF("bedek-bayit-mitbach-06.jpg"),
    GF("bedek-bayit-mitbach-07.jpg"),
    GF("bedek-bayit-mitbach-08.jpg"),
    GF("bedek-bayit-mitbach-09.jpg"),
    GF("bedek-bayit-mitbach-10.jpg"),
    GF("bedek-bayit-mitbach-11.jpg"),
    GF("bedek-bayit-likui-instalatzia-01.jpg"),
    GF("bedek-bayit-likui-instalatzia-02.jpg"),
  ...
  "klim-sanitariim": [
    GF("bedek-bayit-klim-sanitariim-08.jpg"),
  ...
  "mizug-avir": [
    ...
    GF("bedek-bayit-mizug-avir-04.webp"),
    G("bedika-termit-mizug-avir-dira-hadasha"),
    G("bedikat-tikrat-mirpeset-mad-temperatura"),
    G("matzlema-termit-itur-retivut"),
  ],
  "dud-shemesh": [
    GF("bedek-bayit-dud-shemesh-01.webp"),
    GF("bedek-bayit-likui-itum-01.jpg"),
    GF("bedek-bayit-likui-itum-02.jpg"),
    GF("bedek-bayit-likui-itum-03.jpg"),
    GF("bedek-bayit-likui-itum-04.jpg"),
  ...
  negarut: [
    GF("bedek-bayit-mitbach-13.webp"),
    GF("bedek-bayit-negarut-01.jpg"),
    GF("bedek-bayit-negarut-02.jpg"),
    GF("bedek-bayit-negarut-03.jpg"),
    GF("bedek-bayit-negarut-04.jpg"),
    GF("bedek-bayit-negarut-05.jpg"),
    GF("bedek-bayit-negarut-06.jpg"),
    GF("bedek-bayit-negarut-07.jpg"),
    GF("bedek-bayit-negarut-08.jpg"),
    G("zavit-nagarim-bedek-bayit"),
    G("mad-mervachim-feeler-bedek-bayit"),
    G("sargel-pelada-meduyak-bedek-bayit"),
  ],
  ...
  "tikrot-gevs": [
    GF("bedek-bayit-tikrot-gevs-01.jpg"),
    GF("bedek-bayit-tikrot-gevs-02.jpg"),
    GF("bedek-bayit-tikrot-gevs-03.jpg"),
    GF("bedek-bayit-tikrot-gevs-04.jpg"),
    G("matzlema-termit-itur-retivut"),
    G("bedikat-tikrat-mirpeset-mad-temperatura"),
    GF("bedek-bayit-likui-retivut-01.jpg"),
    GF("bedek-bayit-likui-retivut-02.jpg"),
  ...
  "delet-knisa": [
    G("bedek-bayit-petach-or-delet-knisa"),
    GF("bedek-bayit-delet-knisa-03.jpg"),
  ...
  miklachon: [
    GF("bedek-bayit-miklachon-01.jpg"),
    GF("bedek-bayit-miklachon-02.jpg"),
    GF("bedek-bayit-miklachon-03.jpg"),
    GF("bedek-bayit-miklachon-04.jpg"),
    GF("bedek-bayit-miklachon-05.jpg"),
    GF("bedek-bayit-miklachon-06.jpg"),
    GF("bedek-bayit-miklachon-07.jpg"),
    GF("bedek-bayit-miklachon-08.jpg"),
    GF("bedek-bayit-miklachon-09.jpg"),
    GF("bedek-bayit-miklachon-10.jpg"),
    GF("bedek-bayit-klim-sanitariim-02.jpg"),
    GF("bedek-bayit-klim-sanitariim-03.jpg"),
    G("glai-zchuchit-mechusemet-merlin-bedek-bayit"),
    G("mad-oviy-zchuchit-merlin-bedek-bayit"),
  ...
  "ritzuf-chutz": [
    ...
    GF("bedek-bayit-ritzuf-chutz-04.jpg"),
    GF("bedek-bayit-ritzuf-chutz-05.jpg"),
    GF("bedek-bayit-ritzuf-chutz-06.jpg"),
    GF("bedek-bayit-likui-ritzuf-01.jpg"),
    GF("bedek-bayit-likui-ritzuf-02.jpg"),
    GF("bedek-bayit-likui-ritzuf-03.jpg"),
  ...
  marzevim: [
    GF("bedek-bayit-marzevim-01.jpg"),
    GF("bedek-bayit-marzevim-02.jpg"),
    GF("bedek-bayit-marzevim-03.jpg"),
    GF("bedek-bayit-likui-itum-05.jpg"),
    GF("bedek-bayit-likui-itum-06.jpg"),
    G("bedikat-tikrat-mirpeset-mad-temperatura"),
  ],
